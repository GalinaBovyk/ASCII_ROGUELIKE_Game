...
item_chances: Dict[int, List[Tuple[Entity, int]]] = {
    0: [((entity_factories.energy_drink, 40))],
    2: [((entity_factories.nice_note, 20))],
    4: [((entity_factories.deadline_list, 10))],
    6: [((entity_factories.complicated_math_equation, 10))],
    8: [((entity_factories.stink_bomb, 10))],
}
